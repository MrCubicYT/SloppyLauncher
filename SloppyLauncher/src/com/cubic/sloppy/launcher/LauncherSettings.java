...
public class LauncherSettings extends IScreen {
    ...
    public LauncherSettings(final Pane root, final GameEngine engine, final LauncherPanel pane) {
        ...
        //List<String> disabledForgeVersions = Arrays.asList();
        //List<String> disabledOptifineVersions = Arrays.asList();
   ...
   //     }
        ...
        this.versionList.setOnAction(event -> {
            ...
            boolean isForgeRestricted = "1.8".equals(version);
        ...
        this.useMusic.setText("Play Music");
    ...
    private String urlModifier() {
        return "/" + (useForge.isSelected() ? "forge/" : (useOptifine.isSelected() ? "/" : "/"));
    }
